$(document).ready(function () {
    ...
    $('#options input:radio').click(function () {
        ...
        if (id === "population") {
            ...
            $('#change').html("<p>The differences in the data make an overall change unobtainable. However, the data and government news show that hydrologic infrastructure in California has had some improvment but not much. In 1989 the Spicer Meadows Reservoir opened (capacity 190 TAF) and in 1998 the Los Vaqueros Reservoir opened (capacity 160 TAF). Since then 3 other reservoirs have also opened up.</p>");
